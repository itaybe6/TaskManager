...
const styles = StyleSheet.create({
  ...
  errorTxt: { fontSize: 16, fontWeight: '700', color: '#ef4444', textAlign: 'center' },
  backBtn: { paddingHorizontal: 16, paddingVertical: 8, backgroundColor: theme.colors.primary, borderRadius: 10 },
  ...
  headerInfo: { flexDirection: I18nManager.isRTL ? 'row' : 'row-reverse', alignItems: 'center', gap: 14 },
  avatarLarge: { width: 64, height: 64, borderRadius: 20, alignItems: 'center', justifyContent: 'center' },
  avatarLargeTxt: { fontSize: 22, fontWeight: '800' },
  titleCol: { gap: 6 },
  clientName: { fontSize: 26, fontWeight: '800', color: '#0f172a', textAlign: 'right', writingDirection: 'rtl' },
  metaRow: { flexDirection: I18nManager.isRTL ? 'row' : 'row-reverse', alignItems: 'center', gap: 12 },
  metaPill: { backgroundColor: '#e2e8f0', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  metaPillTxt: { fontSize: 11, fontWeight: '700', color: '#64748b' },
  dateTxt: { fontSize: 12, color: '#94a3b8', fontWeight: '600' },
  
  headerActions: { flexDirection: I18nManager.isRTL ? 'row' : 'row-reverse', alignItems: 'center', gap: 10 },
  editBtn: { 
    flexDirection: I18nManager.isRTL ? 'row' : 'row-reverse', 
    alignItems: 'center', 
    gap: 8, 
  ...
  editBtnTxt: { fontSize: 13, fontWeight: '700', color: theme.colors.primary },
  iconBtn: { width: 36, height: 36, borderRadius: 10, backgroundColor: '#fff', borderWidth: 1, borderColor: '#e2e8f0', alignItems: 'center', justifyContent: 'center' },
  
  statsGrid: { flexDirection: I18nManager.isRTL ? 'row' : 'row-reverse', gap: 12 },
  ...
  statValue: { fontSize: 20, fontWeight: '800', textAlign: 'right', writingDirection: 'rtl' },
  
  mainGrid: { flexDirection: I18nManager.isRTL ? 'row' : 'row-reverse', gap: 18 },
  leftCol: { flex: 2, gap: 18 },
  rightCol: { flex: 1, gap: 18 },
  
  section: { backgroundColor: '#fff', borderRadius: 20, padding: 18, borderWidth: 1, borderColor: '#f1f5f9', gap: 16 },
  ...
  emptyTxt: { fontSize: 12, color: '#94a3b8', fontWeight: '600' },
  ...
  docIconWrap: { width: 36, height: 36, borderRadius: 10, backgroundColor: '#f1f5f9', alignItems: 'center', justifyContent: 'center' },
  docInfo: { flex: 1, gap: 2 },
  docTitle: { fontSize: 14, fontWeight: '700', color: '#1e293b', textAlign: 'right', writingDirection: 'rtl' },
  docMeta: { fontSize: 11, color: '#94a3b8', fontWeight: '600', textAlign: 'right', writingDirection: 'rtl' },
  ...
  taskDesc: { fontSize: 14, fontWeight: '700', color: '#1e293b', textAlign: 'right', writingDirection: 'rtl' },
  taskMeta: { fontSize: 11, color: '#94a3b8', fontWeight: '600', textAlign: 'right', writingDirection: 'rtl' },
  statusBadge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 8 },
  statusBadgeTxt: { fontSize: 10, fontWeight: '800' },
  
  contactsList: { gap: 12 },
  contactCard: { backgroundColor: '#f8fafc', borderRadius: 16, padding: 12, gap: 12 },
  contactTop: { flexDirection: I18nManager.isRTL ? 'row' : 'row-reverse', alignItems: 'center', gap: 12 },
  contactAvatar: { width: 34, height: 34, borderRadius: 10, backgroundColor: '#e2e8f0', alignItems: 'center', justifyContent: 'center' },
  contactAvatarTxt: { fontSize: 12, fontWeight: '800', color: '#64748b' },
  contactNameBox: { gap: 2 },
  contactName: { fontSize: 14, fontWeight: '800', color: '#1e293b', textAlign: 'right' },
  contactRole: { fontSize: 11, fontWeight: '600', color: '#94a3b8', textAlign: 'right' },
  contactDetails: { gap: 8 },
  detailRow: { flexDirection: I18nManager.isRTL ? 'row' : 'row-reverse', alignItems: 'center', gap: 10 },
  detailTxt: { fontSize: 12, fontWeight: '600', color: '#475569', textAlign: 'right' },
  
  notesTxt: { fontSize: 13, color: '#475569', lineHeight: 20, textAlign: 'right', writingDirection: 'rtl' },
});
