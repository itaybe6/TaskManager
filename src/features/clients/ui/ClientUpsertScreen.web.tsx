...
export function ClientUpsertScreen({ route, navigation }: any) {
  ...
  const contentMaxWidth = Math.min(1080, Math.max(700, width - 80));
  const footerH = 72;
...
const styles = StyleSheet.create({
  ...
  subtitle: { marginTop: 6, fontSize: 12, fontWeight: '600', textAlign: 'right', writingDirection: 'rtl' },
  ...
  backBtnTxt: { fontSize: 12, fontWeight: '700', textAlign: 'right', writingDirection: 'rtl' },
  ...
  sectionAccent: { width: 4, height: 18, borderRadius: 999 },
  sectionTitle: { fontSize: 16, fontWeight: '800', textAlign: 'right', writingDirection: 'rtl' },
  subSectionTitle: { fontSize: 13, fontWeight: '800', textAlign: 'right', writingDirection: 'rtl', marginBottom: 8 },
  helperTxt: { marginTop: 8, fontSize: 11, fontWeight: '600', textAlign: 'right', writingDirection: 'rtl' },
  ...
  contactTitle: { fontSize: 14, fontWeight: '800', textAlign: 'right', writingDirection: 'rtl' },
  iconCircleBtn: { width: 32, height: 32, borderRadius: 999, alignItems: 'center', justifyContent: 'center' },

  label: { fontSize: 12, fontWeight: '700', textAlign: 'right', writingDirection: 'rtl' },
  inputWrap: { position: 'relative' },
  inputIcon: { position: 'absolute', right: 12, top: 12, opacity: 0.95 },
  input: {
    height: 42,
    borderRadius: 12,
    paddingRight: 38,
  ...
  footerBtnTxt: { fontSize: 12, fontWeight: '800', textAlign: 'right', writingDirection: 'rtl' },
  saveBtn: {
    height: 38,
  ...
  saveBtnTxt: { color: '#fff', fontSize: 12, fontWeight: '900', textAlign: 'right', writingDirection: 'rtl' },
});
